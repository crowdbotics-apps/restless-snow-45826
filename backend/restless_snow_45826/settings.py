"""
Django settings for restless_snow_45826 project.
...
ROOT_URLCONF = 'restless_snow_45826.urls'
...
WSGI_APPLICATION = 'restless_snow_45826.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_snow_45826 API",
    "DESCRIPTION": "API documentation for restless_snow_45826 App",
    "VERSION": "v1",
}
